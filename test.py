...
def main():
    ...
    print("loading and evaluating HMM model...")
    ...
    # 加载并评估CRF模型
    print("loading and evaluating CRF model...")
    ...
    # bilstm模型
    print("loading and evaluating BI-LSTM model...")
    ...
    print("loading and evaluating BI-LSTM-CRF model...")
